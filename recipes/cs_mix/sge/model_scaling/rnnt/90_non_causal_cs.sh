...
EXPERIMENT="90M__non_causal____rnnt"
...
args=(
  ...
  --from_pretrained="/mnt/matylda6/szoke/EU-ASR/EU-ASR-Codebase/model_pretraining/models/EBF-BRQ-90M-nonSTR-L18-H384-CB4x1024x16-80x384x2d-M06_MVN_MCV-VP-LELD_LR1e3_wu20k/checkpoint-190000_ep1.5/"
  )
