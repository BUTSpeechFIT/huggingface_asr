#!/bin/bash
#$ -N honza_init_mw_ua_lora_8
#$ -q long.q@supergpu*
#$ -l ram_free=40G,mem_free=40G
#$ -l matylda6=0.5,scratch=0.5
#$ -l gpu=2,gpu_ram=20G
#$ -o /mnt/matylda6/isedlacek/projects/job_logs/eloquence/dst/honza_init_mw_ua_lora_8.o
#$ -e /mnt/matylda6/isedlacek/projects/job_logs/eloquence/dst/honza_init_mw_ua_lora_8.e
N_GPUS=2
EXPERIMENT="honza_init_mw_ua_lora_8"
...
args=(
  ...
  --test_splits sa_multiwoz_dev sa_multiwoz_test_verbatim sa_multiwoz_test_paraphrased
  ...
  #--base_decoder_model="/mnt/matylda3/isvecjan/workspace/olmo-finetune/exp/ft-olmo1b-fully-spokenwoz_multiwoz-batch128-contextUserAgent/checkpoint-600"
  --base_decoder_model="/mnt/matylda3/isvecjan/workspace/olmo-finetune/exp/ft-olmo1b-fully-multiwoz-batch128-contextUserAgent/checkpoint-500"
  --decoder_copy
