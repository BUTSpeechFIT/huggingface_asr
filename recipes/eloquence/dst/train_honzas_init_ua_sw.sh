#!/bin/bash
#$ -N honza_init_sw_ua_lora_8
#$ -q long.q@supergpu*
#$ -l ram_free=40G,mem_free=40G
#$ -l matylda6=0.5,scratch=0.5
#$ -l gpu=2,gpu_ram=20G
#$ -o /mnt/matylda6/isedlacek/projects/job_logs/eloquence/dst/honza_init_sw_ua_lora_8.o
#$ -e /mnt/matylda6/isedlacek/projects/job_logs/eloquence/dst/honza_init_sw_ua_lora_8.e
N_GPUS=2
EXPERIMENT="honza_init_sw_ua_lora_8"
