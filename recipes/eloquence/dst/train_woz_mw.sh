...
#$ -l gpu=2,gpu_ram=20G
#$ -o /mnt/matylda6/isedlacek/projects/job_logs/eloquence/dst/mwoz_pure.o
#$ -e /mnt/matylda6/isedlacek/projects/job_logs/eloquence/dst/mwoz_pure.e
N_GPUS=2
EXPERIMENT="mwoz_pure"
...
args=(
  ...
  --from_pretrained="/mnt/matylda6/isedlacek/projects/huggingface_asr/exp/mwoz_pure/checkpoint-4000" # base connector
