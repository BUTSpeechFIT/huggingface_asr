#!/bin/bash
#$ -N spokenwoz_multiwoz_lora_r16a16_bs96_np
#$ -q all.q@supergpu*
#$ -l h=!supergpu14
#$ -l ram_free=40G,mem_free=40G
#$ -l matylda6=0.5,scratch=0.5
#$ -l gpu=2,gpu_ram=20G
#$ -o /mnt/matylda6/isedlacek/projects/job_logs/eloquence/dst/spokenwoz_multiwoz_lora_r16a16_bs96_np.o
#$ -e /mnt/matylda6/isedlacek/projects/job_logs/eloquence/dst/spokenwoz_multiwoz_lora_r16a16_bs96_np.e
N_GPUS=2
EXPERIMENT="spokenwoz_multiwoz_lora_r16a16_bs96_np"
...
args=(
  ...
  #--restart_from="/mnt/matylda6/isedlacek/projects/huggingface_asr/exp/spokenwoz_multiwoz_lora_r16a16_bs96_np/checkpoint-1000"
  --from_pretrained="/mnt/matylda6/isedlacek/projects/huggingface_asr/exp/spokenwoz_multiwoz_lora_r16a16_bs96_np/checkpoint-2000"
