#!/bin/bash
#$ -N predict_mwoz_lora_r16a16_np_ua_cbs
#$ -q all.q@supergpu14
#$ -l ram_free=40G,mem_free=40G
#$ -l matylda6=0.5,scratch=0.5
#$ -l gpu=2,gpu_ram=20G
#$ -o /mnt/matylda6/isedlacek/projects/job_logs/eloquence/dst/predict_mwoz_lora_r16a16_np_ua_cbs.o
#$ -e /mnt/matylda6/isedlacek/projects/job_logs/eloquence/dst/predict_mwoz_lora_r16a16_np_ua_cbs.e
N_GPUS=2
EXPERIMENT="predict_mwoz_lora_r16a16_np_ua_cbs"
...
args=(
  ...
  --per_device_eval_batch_size="10" # 24
  ...
  --prompt_prefix=""
  --constrained_beam_search domains slots
  ...
  --from_pretrained="/mnt/matylda6/isedlacek/projects/huggingface_asr/exp/mwoz_lora_r16a16_np_ua/checkpoint-2000"
