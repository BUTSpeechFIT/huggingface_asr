#!/bin/bash
#$ -N spokenwoz_multiwoz_lora_r16a16_bs96_np_ua_ftmw1ep
#$ -q all.q@supergpu*
#$ -l h=!supergpu14
#$ -l ram_free=20G,mem_free=20G
#$ -l matylda6=0.5,scratch=0.5
#$ -l gpu=2,gpu_ram=20G
#$ -o /mnt/matylda6/isedlacek/projects/job_logs/eloquence/dst/spokenwoz_multiwoz_lora_r16a16_bs96_np_ua_ftmw1ep.o
#$ -e /mnt/matylda6/isedlacek/projects/job_logs/eloquence/dst/spokenwoz_multiwoz_lora_r16a16_bs96_np_ua_ftmw1ep.e
N_GPUS=2
EXPERIMENT="spokenwoz_multiwoz_lora_r16a16_bs96_np_ua_ftmw1ep"
...
args=(
  ...
  --test_splits sa_multiwoz_test_verbatim_gt
  ...
  #--from_pretrained="/mnt/matylda6/isedlacek/projects/huggingface_asr/exp/spokenwoz_multiwoz_lora_r16a16_bs96_np_ua/checkpoint-4000"
  --from_pretrained="/mnt/matylda6/isedlacek/projects/huggingface_asr/exp/spokenwoz_multiwoz_lora_r16a16_bs96_np_ua_ftmw1ep/checkpoint-251"
