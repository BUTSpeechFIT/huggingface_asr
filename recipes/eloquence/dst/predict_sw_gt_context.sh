#!/bin/bash
#$ -N predict_spokenwoz_multiwoz_lora_r16a16_bs96_np_ua_ftsw1ep_gtc
#$ -q long.q@supergpu*
#$ -l h=!supergpu14
#$ -l ram_free=40G,mem_free=40G
#$ -l matylda6=0.5,scratch=0.5
#$ -l gpu=3,gpu_ram=20G
#$ -o /mnt/matylda6/isedlacek/projects/job_logs/eloquence/dst/predict_spokenwoz_multiwoz_lora_r16a16_bs96_np_ua_ftsw1ep_gtc.o
#$ -e /mnt/matylda6/isedlacek/projects/job_logs/eloquence/dst/predict_spokenwoz_multiwoz_lora_r16a16_bs96_np_ua_ftsw1ep_gtc.e
N_GPUS=3
EXPERIMENT="predict_spokenwoz_multiwoz_lora_r16a16_bs96_np_ua_ftsw1ep_gtc"
...
args=(
  ...
  #--test_splits sa_multiwoz_test_verbatim sa_multiwoz_test_paraphrased sa_multiwoz_dev
  ...
  --from_pretrained="/mnt/matylda6/isedlacek/projects/huggingface_asr/exp/spokenwoz_multiwoz_lora_r16a16_bs96_np_ua_ftsw1ep/checkpoint-385"
