#!/bin/bash
#$ -N predict_mwoz_lora_r16a16_np_ua_gtc
#$ -q all.q@supergpu*
#$ -l h=!supergpu14
#$ -l ram_free=20G,mem_free=20G
#$ -l matylda6=0.5,scratch=0.5
#$ -l gpu=2,gpu_ram=20G
#$ -o /mnt/matylda6/isedlacek/projects/job_logs/eloquence/dst/predict_mwoz_lora_r16a16_np_ua_gtc.o
#$ -e /mnt/matylda6/isedlacek/projects/job_logs/eloquence/dst/predict_mwoz_lora_r16a16_np_ua_gtc.e
N_GPUS=2
EXPERIMENT="predict_mwoz_lora_r16a16_np_ua_gtc"
