#!/bin/bash
#$ -N mwoz_lora_r16a16_np
#$ -q all.q@supergpu*
#$ -l h=!supergpu14
#$ -l ram_free=20G,mem_free=20G
#$ -l matylda6=0.5,scratch=0.5
#$ -l gpu=2,gpu_ram=20G
#$ -o /mnt/matylda6/isedlacek/projects/job_logs/eloquence/dst/mwoz_lora_r16a16_np.o
#$ -e /mnt/matylda6/isedlacek/projects/job_logs/eloquence/dst/mwoz_lora_r16a16_np.e
N_GPUS=2
EXPERIMENT="mwoz_lora_r16a16_np"
...
args=(
  ...
  --from_pretrained="/mnt/matylda6/isedlacek/projects/huggingface_asr/exp/mwoz_lora_r16a16_np/checkpoint-1000"
