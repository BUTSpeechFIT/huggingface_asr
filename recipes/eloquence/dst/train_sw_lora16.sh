#!/bin/bash
#$ -N spokenwoz_lora_r16a16_bs96_np
#$ -q long.q@supergpu*
#$ -l ram_free=40G,mem_free=40G
#$ -l matylda6=0.5,scratch=0.5
#$ -l gpu=2,gpu_ram=20G
#$ -o /mnt/matylda6/isedlacek/projects/job_logs/eloquence/dst/spokenwoz_lora_r16a16_bs96_np.o
#$ -e /mnt/matylda6/isedlacek/projects/job_logs/eloquence/dst/spokenwoz_lora_r16a16_bs96_np.e
N_GPUS=2
EXPERIMENT="spokenwoz_lora_r16a16_bs96_np"
