...
#$ -l gpu=2,gpu_ram=20G
#$ -o /mnt/matylda6/isedlacek/projects/job_logs/eloquence/dst/mwoz_lora_r8a8_np.o
#$ -e /mnt/matylda6/isedlacek/projects/job_logs/eloquence/dst/mwoz_lora_r8a8_np.e
N_GPUS=2
EXPERIMENT="mwoz_lora_r8a8_np"
...
args=(
  ...
  --from_pretrained="/mnt/matylda6/isedlacek/projects/huggingface_asr/exp/mwoz_lora_r8a8_np/checkpoint-1000" # base connector
