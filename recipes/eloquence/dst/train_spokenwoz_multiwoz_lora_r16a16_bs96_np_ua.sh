...
N_GPUS=2
EXPERIMENT="spokenwoz_multiwoz_lora_r16a16_bs96_np_ua"
...
args=(
  ...
  --from_pretrained="/mnt/matylda6/isedlacek/projects/huggingface_asr/exp/spokenwoz_multiwoz_lora_r16a16_bs96_np_ua/checkpoint-4000" # base connector
