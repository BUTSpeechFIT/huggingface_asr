#!/bin/bash
#$ -N predict_spokenwoz_multiwoz_lora_r16a16_ua
#$ -q long.q@supergpu*
#$ -l ram_free=40G,mem_free=40G
#$ -l matylda6=0.5,scratch=0.5
#$ -l gpu=4,gpu_ram=20G
#$ -o /mnt/matylda6/isedlacek/projects/job_logs/eloquence/dst/predict_spokenwoz_multiwoz_lora_r16a16_ua.o
#$ -e /mnt/matylda6/isedlacek/projects/job_logs/eloquence/dst/predict_spokenwoz_multiwoz_lora_r16a16_ua.e
N_GPUS=4
EXPERIMENT="predict_spokenwoz_multiwoz_lora_r16a16_ua"
...
args=(
  ...
  --from_pretrained="/mnt/matylda6/isedlacek/projects/huggingface_asr/exp/spokenwoz_multiwoz_lora_r16a16_ua/checkpoint-4000"
