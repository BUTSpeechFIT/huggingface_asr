#!/bin/bash
#$ -N eval_bolaji_slurp_ft_10_orig
#$ -q short.q@supergpu18
#$ -l ram_free=40G,mem_free=40G
#$ -l matylda6=0.5,matylda5=0.1,scratch=0.2
#$ -l gpu=1,gpu_ram=20G
#$ -o /mnt/matylda6/isedlacek/projects/job_logs/eloquence/eval_bolaji_slurp_ft_10_orig.o
#$ -e /mnt/matylda6/isedlacek/projects/job_logs/eloquence/eval_bolaji_slurp_ft_10_orig.e
N_GPUS=1
EXPERIMENT="eval_bolaji_slurp_ft_10_orig"
