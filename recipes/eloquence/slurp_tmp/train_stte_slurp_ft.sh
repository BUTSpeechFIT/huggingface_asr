...
#$ -l gpu=1,gpu_ram=20G
#$ -o /mnt/matylda6/isedlacek/projects/job_logs/eloquence/bolaji_slurp_ft.o
#$ -e /mnt/matylda6/isedlacek/projects/job_logs/eloquence/bolaji_slurp_ft.e
N_GPUS=1
EXPERIMENT="bolaji_slurp_ft"
