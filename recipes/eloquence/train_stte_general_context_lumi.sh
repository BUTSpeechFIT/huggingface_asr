#!/bin/bash
#SBATCH --job-name=re_wll_olmo1b_general_context_asr_fisher_libri_how2_freeze_enc_context3_labels_nostr_from_train_enc_context0_38k
...
#DATASETS="${RECIPE_DIR}/datasets_fisher_ctx_lumi.json"
#DATASETS="${RECIPE_DIR}/datasets_context.json"
DATASETS="${RECIPE_DIR}/datasets_context_lumi.json"
...
args=(
  ...
  --from_pretrained="/scratch/project_465000970/bolaji/exp/wll_olmo1b_general_context_asr_fisher_libri_how2_train_enc_context0_labels_nostr/checkpoint-38000"
#  --from_pretrained="/scratch/project_465000970/bolaji/exp/wll_olmo1b_general_context_asr_fisher_libri_how2_freeze_enc_context0_labels_nostr/checkpoint-28000"
