...
EXPERIMENT="ebranchformer_czech_small_v3"
PROJECT="regularizations_czech_corpus"
WORK_DIR="/mnt/proj1/open-28-57/szoke/huggingface_asr"
ENV_DIR="/mnt/proj1/open-28-57/szoke/Alex-ASR"
RECIPE_DIR="${WORK_DIR}/recipes/ebranchformer_english"

export HF_HOME="/scratch/project/open-28-57/lakoc/huggingface_cache" # cache is taken from Alex
