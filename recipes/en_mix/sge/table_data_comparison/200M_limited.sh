...
args=(
  ...
  --bf16
  --restart_from="/mnt/matylda5/ipoloka/projects/huggingface_asr/experiments/200M___vox_cv/checkpoint-132107"
  ...
  --datasets_creation_config="${RECIPE_DIR}/datasets_reduced_normalized.json"
