...
args=(
  ...
  --base_encoder_model="Lakoc/bestrq_ebranchformer_12_512h_2d_enhanced"
...
"${SRC_DIR}/cluster_utilities/LUMI/start_multinode_job_inside_env_pure_python.sh"  src/trainers/train_ctc_pretraining_asr.py "${args[@]}"
