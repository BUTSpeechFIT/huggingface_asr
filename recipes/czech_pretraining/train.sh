...
EXPERIMENT="bestrq_ebranchformer_90M_from_scratch"
...
args=(
  ...
  --base_encoder_model="/scratch/project_465000836/ipoloka/huggingface_asr/experiments/bestrq_ebranchformer_90M_v3/checkpoint-35834/"
  --expect_2d_input
