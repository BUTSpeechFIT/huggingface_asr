...
#SBATCH --output="outputs/czech_pretraining/output_finetune_%x_%j.out"
#SBATCH --error="outputs/czech_pretraining/output_finetune_%x_%j.err"
...
args=(
  ...
  --pad_to_multiples_of="16000"

  # Preprocessing related arguments
  --data_preprocessing_config="${RECIPE_DIR}/data_preprocessing_cltrus.json"

  # Model related arguments
  --tokenizer_name="Lakoc/uni500_cz"
  --feature_extractor_name="fav-kky/wav2vec2-base-cs-80k-ClTRUS"
  --from_pretrained="fav-kky/wav2vec2-base-cs-80k-ClTRUS"
