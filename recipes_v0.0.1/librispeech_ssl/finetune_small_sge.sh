...
EXPERIMENT="baseline_from_pretrained_frozen_ft_v3.1"
...
args=(
  ...
  --tokenizer_name="Lakoc/libri_100"
  --feature_extractor_name="Lakoc/fe_mel_wo_norm"
  --from_pretrained="/mnt/scratch/tmp/ipoloka/hf_exp/experiments/bestrq_sge_small_input_norm/checkpoint-20120/"
  --freeze_encoder
  --config_overrides="finetune_with_additional_layer=True,finetune_with_layer_mixing=True,freeze_norm_for_finetunning=True"
