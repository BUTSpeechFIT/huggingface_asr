...
EXPERIMENT="ebranchformer_english_medium_regularized_decoding2"
...
args=(
  ...
  --datasets_creation_config="${RECIPE_DIR}/datasets_pure.json"
  ...
  --from_pretrained="/mnt/proj1/open-28-58/lakoc/huggingface_asr/experiments/ebranchformer_english_medium_regularized/checkpoint-715000"
