...
EXPERIMENT="bestrq_ebranchformer_90M_pretrained_full_czech_streaming"
...
args=(
  ...
  --from_pretrained="/scratch/project_465000836/ipoloka/huggingface_asr/experiments/bestrq_ebranchformer_97M_streaming/checkpoint-30000/"
