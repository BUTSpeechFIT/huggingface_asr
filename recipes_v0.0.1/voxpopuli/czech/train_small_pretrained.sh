...
#SBATCH --output="outputs/voxpopuli_czech/output_%x_%j.out"
#SBATCH --error="outputs/voxpopuli_czech/output_%x_%j.err"
#SBATCH --partition=standard-g
#SBATCH --mem=120G
#SBATCH --time=24:00:00

EXPERIMENT="vanilla_transformer_pretrained_czech"
...
args=(
  ...
  --from_pretrained="/scratch/project_465000836/szoke/experiments//experiments/EC_small_bestrq-obj_cz_data_v6/checkpoint-42000/"
#  --base_encoder_model="Lakoc/ebranchformer_6_128h_2d_bestrq"
  --expect_2d_input
