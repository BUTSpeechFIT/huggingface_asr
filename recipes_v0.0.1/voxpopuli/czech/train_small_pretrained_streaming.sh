...
EXPERIMENT="ebranchformer_small_streaming_pretrained_newer_checkpoint_frozen_encoder3"
...
args=(
  ...
  --from_pretrained="/project/project_465000836/szoke/huggingface_asr/experiments/ebf_cz_medium_streaming_wav2vec-obj_v1_lr1e-5_bf16_bs32_mgn05_c1/checkpoint-420000"
  --expect_2d_input
