...
class ModelArguments:
    ...
    init_encoder: Optional[str] = field(
        default=None,
        metadata={
            "help": "Path to pretrained model or model identifier from huggingface.co/models to initialize the encoder with"
        },
    )
    ...
    replace_aligned_decoder: Optional[bool] = field(
        default=False,
        metadata={
            "help": "Whether to replace the decoder of the model specified in from_pretrained."
        },
    )
    ...
    expect_2d_input: Optional[bool] = field(
        default=False, metadata={"help": "Whether to expect 2d input for encoder."}
    )
    ...
    whisper_task: Optional[str] = field(
    ...
    finetune_mixing_mechanism: Optional[str] = field(
        default=None,
        metadata={"help": "Type of mixing mechanism to use for finetuning."},
    )
    ...
    layer_to_extract: Optional[int] = field(
        default=None,
        metadata={
            "help": "Intermediate layer from which to extract encoder features; defaults to output layer"
        },
    )
...
class GeneralTrainingArguments(Seq2SeqTrainingArguments):
    ...
    do_generate_sequential: Optional[bool] = field(
        default=False,
        metadata={"help": "Whether to run generation for DST in sequential fashion."},
    )
    restart_from: Optional[str] = field(
        default="",
        metadata={"help": "Path to checkpoint used to restart the training."},
    )
    ...
    tokenizer_source_name: Optional[str] = field(
        default=None,
        metadata={
            "help": "Pretrained tokenizer name or path for the encoder source language."
        },
    )
    ...
    joint_decoding_during_training: Optional[bool] = field(
        default=False,
        metadata={"help": "Whether to use joint decoding during training."},
    )
    freeze_encoder_epochs: Optional[int] = field(
        default=None,
        metadata={"help": "Freezes the encoder for the specified number of epochs."},
    )
    qformer_eval_callback: Optional[bool] = field(
        default=False,
        metadata={
            "help": "Makes sure the encoder and decoder for a qformer model are put into eval mode for training."
        },
    )
    qf_enc_unfreeze_epochs: Optional[int] = field(
        default=None,
        metadata={
            "help": "Unfreezes the qformer model encoder after a certain number of epochs."
        },
    )
    qf_dec_unfreeze_epochs: Optional[int] = field(
        default=None,
        metadata={
            "help": "Unfreezes the qformer model decoder after a certain number of epochs."
        },
    )
    qf_pretrain_epochs: Optional[int] = field(
        default=0, metadata={"help": "Number of pretraining epochs for the Qformer."}
    )
    mask_unks: Optional[bool] = field(
        default=False,
        metadata={"help": "Whether to mask unknown tokens for cross entropy."},
    )
    use_start_method_spawn: Optional[bool] = field(
        default=False,
        metadata={"help": "Whether multiprocessing should be started by spawn"},
    )
...
class PretrainingArguments(GeneralTrainingArguments):
    ...
    gumbel_temperature_decay: Optional[float] = field(
        default=0.999995, metadata={"help": "Gumbel temperature decay."}
    )
    min_gumbel_temperature: Optional[float] = field(
        default=0.5, metadata={"help": "Minimum Gumbel temperature."}
    )
    max_gumbel_temperature: Optional[float] = field(
        default=2.0, metadata={"help": "Maximum Gumbel temperature."}
    )
...
class GenerationArguments:
    ...
    max_new_tokens: Optional[int] = field(
        default=200,
        metadata={
            "help": "Max number of tokens generated after the prompt for decoder-only models."
        },
    )
    ...
    low_memory: Optional[bool] = field(
        default=False, metadata={"help": "Whether to use sequential beam search."}
    )
    post_process_predictions: Optional[bool] = field(
        default=False, metadata={"help": "Whether to post process predictions."}
    )
    apply_eos_space_trick: Optional[bool] = field(
        default=False, metadata={"help": "Whether to apply eos space trick."}
    )
    eos_space_trick_weight: Optional[float] = field(
        default=0.0, metadata={"help": "Weight of eos space trick."}
    )
    space_token_id: Optional[int] = field(
        default=-1, metadata={"help": "Space token id."}
    )
    override_for_evaluation: Optional[str] = field(
        default=None,
        metadata={
            "help": "Arguments to override for evaluation. Example: "
            "decoding_ctc_weight=0.3;lm_model=gpt2"
        },
    )
    no_metrics: Optional[bool] = field(
        default=False,
        metadata={
            "help": "Disables generation and metric computation in the evaluate loop. Useful for speeding up the evaluation."
        },
    )
...
class DataTrainingArguments:
    ...
    dataset_config: Optional[str] = field(
        default=None,
        metadata={
            "help": "The config of the dataset to use (via the datasets library)."
        },
    )
    data_dir: Optional[str] = field(
        default=None,
        metadata={
            "help": "The path to the data directory, used with specific dataset builders."
        },
    )
    datasets_creation_config: Optional[str] = field(
        default=None,
        metadata={
            "help": "Path to dictionary containing setups for multiple datasets."
        },
    )
    ...
    skip_audio_processing: Optional[bool] = field(
        default=False,
        metadata={
            "help": "Whether to skip the audio pre-preocessing stage when preparing the dataset."
        },
    )
    ...
    text_transformations: Optional[List[str]] = field(
        default=None,
        metadata={"help": "List of transformations to apply to the text. "},
    )
    ...
    context_text_column_name: Optional[str] = field(
        default="text",
        metadata={
            "help": "The name of the dataset column containing the text data for datasets utilizing context. Defaults to 'text'. Currently only works when using a single dataset."
        },
    )
    ...
    validation_slice: Optional[str] = field(
    ...
    cut_validation_from_train: Optional[bool] = field(
        default=False,
        metadata={"help": "Whether to cut validation split from train split."},
    )
    ...
    reshuffle_at_start: Optional[bool] = field(
        default=False,
        metadata={
            "help": "Whether to reshuffle the dataset at the start of preprocessing."
        },
    )
    pad_to_multiples_of: Optional[int] = field(
        default=None,
        metadata={"help": "Used in collator to pad to the multiples of x."},
    )
    dump_prepared_dataset: Optional[str] = field(
        default=None,
        metadata={
            "help": "Path where to dump prepared datasets so it may be read preprocessed from single location."
        },
    )
    ...
    load_pure_dataset_only: Optional[bool] = field(
        default=False,
        metadata={
            "help": "Whether to load only the pure dataset without any preprocessing."
        },
    )
    how2_low_resource_split_file: Optional[str] = field(
        default=None,
        metadata={
            "help": "Path to a file specifying utterance ids to keep in the how2 dataset."
        },
    )
    fisher_context_prefix: Optional[str] = field(
        default="Conversation context: ",
        metadata={"help": "Text prefix to the fisher conversation context."},
    )
    fisher_context_mode: Optional[str] = field(
        default="default",
        metadata={"help": "Fisher conversation data collator operation mode."},
    )
    ...
    fisher_context_trunc_to_shortest: Optional[bool] = field(
        default=False,
        metadata={
            "help": "Whether to truncate the fisher context to the shortest context length in the batch."
        },
    )
    ...
    slurp_dump_pred: Optional[bool] = field(
        default=False,
        metadata={"help": "Whether to dump all predictions into the wandb file.."},
    )
    do_not_remove_columns: Optional[List[str]] = field(
        default=None,
        metadata={"help": "List of column names to keep in the merged dataset."},
    )
    woz_use_agent_history: Optional[bool] = field(
        default=False,
        metadata={"help": "Whether to use agent history in dialogue datasets."},
    )
    woz_use_gt_context: Optional[bool] = field(
        default=False,
        metadata={
            "help": "Whether to use the ground truth context when running inference on woz data."
        },
    )
    constrained_beam_search: Optional[List[str]] = field(
        default=None,
        metadata={"help": "List of keywords for the constrained_beam_search. "},
    )
...
class ModelArgumentsContext(ModelArguments):
    ...
    enc_memory_cells_location: List[int] = field(
        default=None,
        metadata={"help": "Positions where to place memory cells in encoder"},
    )
    dec_memory_cells_location: List[int] = field(
        default=None,
        metadata={"help": "Positions where to place memory cells in decoder"},
    )
...
class TokenizerTrainingArguments:
    ...
    tokenizer_type: Optional[str] = field(
        default="unigram",
        metadata={"help": "Type of tokenizer to create if does not exists."},
    )
...
class ConnectorArguments:
    ...
    qformer_config: Optional[str] = field(
        default=None,
        metadata={
            "help": "Path to pretrained qformer model/config or model/config identifier from huggingface.co/models"
        },
    )
    prompt_tuning_prefix_len: Optional[int] = field(
        default=0, metadata={"help": "Number of prefix embeddings for prompt tuning."}
    )
    prompt_tuning_suffix_len: Optional[int] = field(
        default=0, metadata={"help": "Number of suffix embeddings for prompt tuning."}
    )
    init_prompt_from_embeds: Optional[bool] = field(
        default=False,
        metadata={
            "help": "Whether to use the mean LLM embedding as the initalization point for the soft prompts (slow convergence)."
        },
    )
    prompt_tuning_prefix_init: Optional[str] = field(
        default=None,
        metadata={
            "help": "Base text prompt prefix to initialize the soft prompt tuning."
        },
    )
    prompt_tuning_suffix_init: Optional[str] = field(
        default=None,
        metadata={
            "help": "Base text prompt suffix to initialize the soft prompt tuning."
        },
    )
    connector_type: Optional[str] = field(
        default="qformer",
        metadata={"help": "Architecture of the bridge network (qformer, conv)."},
    )
    prompt_prefix: Optional[str] = field(
        default=None,
        metadata={"help": "Text prompt prefix to the connector output soft prompt."},
    )
    prompt_suffix: Optional[str] = field(
        default=None,
        metadata={"help": "Text prompt suffix to the connector output soft prompt."},
    )
    decoder_lora: Optional[bool] = field(
        default=False, metadata={"help": "Whether to use LoRA for the decoder LM."}
    )
    decoder_lora_rank: Optional[int] = field(
        default=8, metadata={"help": "Rank of the LoRA for the decoder LM."}
    )
    decoder_lora_alpha: Optional[int] = field(
        default=8, metadata={"help": "Alpha of the LoRA for the decoder LM."}
    )
    decoder_lora_dropout: Optional[float] = field(
        default=0.0, metadata={"help": "LoRA dropout for the decoder LM."}
    )
    decoder_copy: Optional[bool] = field(
        default=False,
        metadata={
            "help": "Whether copy the decoder LM after initiaization from checkpoint."
        },
    )
    quantize_decoder: Optional[int] = field(
        default=None,
        metadata={
            "help": "Which BnB decoder quantization config to use (8bit, 4bit). FIXME: quant. order not working yet"
        },
    )
    n_queries: Optional[int] = field(
        default=80, metadata={"help": "Number of qformer queries."}
    )
    downsampling_factor: Optional[int] = field(
        default=4,
        metadata={
            "help": "When using the stacking downsampling method, concatenate 'N' consecutive embeddings."
        },
    )
    conn_layers: Optional[int] = field(
        default=6, metadata={"help": "Number of qformer layers."}
    )
    conn_hidden_size: Optional[int] = field(
        default=256, metadata={"help": "Qformer hidden dimension."}
    )
    conn_attn_heads: Optional[int] = field(
        default=6, metadata={"help": "Number of qformer heads."}
    )
    qf_intermediate_size: Optional[int] = field(
        default=2048, metadata={"help": "Qformer intermediate layer dimension."}
    )
    qf_mm_pooling: Optional[str] = field(
        default=None, metadata={"help": "Modality-matching loss pooling method."}
    )
    qf_mm_micro_loss: Optional[str] = field(
        default="dot", metadata={"help": "Modality-matching micro loss function."}
    )
    qf_mm_loss_weight: Optional[float] = field(
        default=0.0, metadata={"help": "Modality-matching loss weight."}
    )
