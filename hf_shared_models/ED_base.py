...
if __name__ == "__main__":
    ...
    model = JointCTCAttentionEncoderDecoder.from_pretrained(
        "/mnt/matylda5/ipoloka/IS24_DeCRED/multidomain/normalised_data/ED_base/checkpoint-233632"
    )
    ...
    generation_config.push_to_hub("BUT-FIT/ED-base", private=True)
    feature_extractor.push_to_hub("BUT-FIT/ED-base", private=True)
    tokenizer.push_to_hub("BUT-FIT/ED-base", private=True)
    model.push_to_hub("BUT-FIT/ED-base", private=True)
